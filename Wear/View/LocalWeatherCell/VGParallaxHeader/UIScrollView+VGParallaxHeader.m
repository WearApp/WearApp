...
- (void)setupContentViewMode
{
    switch (self.mode) {
        ...
        case VGParallaxHeaderModeCenter:
            ...
            break;
        case VGParallaxHeaderModeBottom:
            [self addContentViewModeBottomConstraints];
            break;
        default:
            [self addContentViewModeCenterConstraints];
            break;
...
- (void)addContentViewModeBottomConstraints
{
    [self.contentView autoPinEdgeToSuperviewEdge:ALEdgeLeft
                                       withInset:0];
    [self.contentView autoPinEdgeToSuperviewEdge:ALEdgeRight
    ...
    NSArray *array = [self.contentView autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 0, self.originalTopInset, 0)
