...
-(void)generate
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[viewMain]-verticalDistance-[viewTop(==tabHeight)]|" options:0 metrics:@{@"tabHeight":@(tabHeight),@"verticalDistance":@(verticalDistance)} views:NSDictionaryOfVariableBindings(viewTop,viewMain)]];
